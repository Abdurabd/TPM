<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestCalendarAdmin.aspx.cs" Inherits="TrainerPage.RequestCalendarAdmin" %>
...
<body>
    ...
    <div>
        <asp:Calendar ID="Calendar1" runat="server" OnDayRender="Calendar1_DayRender" Height="243px" Width="498px"></asp:Calendar>
        <br />
    </div>
