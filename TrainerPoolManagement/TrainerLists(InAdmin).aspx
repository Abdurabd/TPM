<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainerLists(InAdmin).aspx.cs" Inherits="TrainerPage.TrainerLists_InAdmin_" %>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" EmptyDataText="No records found" OnRowDataBound="GridView1_RowDataBound" CellPadding="4" CellSpacing="4" CssClass="grid-background-color">
            <columns>
               ...
               <%--  <asp:BoundField DataField="skillset" HeaderText="Skillset" />--%>
                  <asp:HyperLinkField Text="See More Details" HeaderText="" DataNavigateUrlFields="trainerId" DataNavigateUrlFormatString="TrainerShowMoreDetails.aspx?trainerId={0}" ControlStyle-CssClass="forgot-pass-link"/>
